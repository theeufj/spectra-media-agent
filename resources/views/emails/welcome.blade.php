...
@section('title', 'Welcome to ' . ($tenantName ?? 'Site to Spend'))

@section('content')
    <h1>Welcome Aboard!</h1>
    <p>Hi {{ $name }},</p>
    <p>We're thrilled to have you join {{ $tenantName ?? 'Site to Spend' }}. You're just a few steps away from launching your first AI-powered ad campaign.</p>
