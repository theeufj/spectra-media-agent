...
@section('content')
    ...
    <p style="text-align: center; margin-top: 30px; margin-bottom: 30px;">
        <a href="{{ ($tenantBaseUrl ?? url('')) }}/dashboard" style="background: linear-gradient(135deg, #ff4d00 0%, #cc3d00 100%); color: #ffffff; padding: 14px 28px; text-decoration: none; border-radius: 6px; font-weight: 700;">View Dashboard</a>
    </p>
