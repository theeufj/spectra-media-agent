...
<body>
    {{-- Cover Page --}}
    <div class="cover">
        <div class="cover-logo">SITE TO SPEND</div>
    ...
    <div class="page">
        <div class="section">
            <div class="section-title">Why Site to Spend?</div>
    ...
    <div class="page-footer">
        <p>This proposal was generated by Site to Spend's AI-powered platform &middot; {{ $proposal->client_name }} &middot; {{ now()->format('F Y') }}</p>
