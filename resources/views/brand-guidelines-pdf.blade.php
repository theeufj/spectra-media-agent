...
<body>
    <div class="header">
        ...
        <div class="meta">
            ...
            @endif
            <span class="badge badge-info">Quality: {{ $brandGuideline->extraction_quality_score }}/100</span>
        </div>
    </div>

    @if($brandGuideline->extraction_quality_score)
    <div class="quality-score">
        <div class="quality-score-value">{{ $brandGuideline->extraction_quality_score }}</div>
    ...
    <div class="footer">
        <p>This brand guidelines report was automatically generated by Site to Spend</p>
