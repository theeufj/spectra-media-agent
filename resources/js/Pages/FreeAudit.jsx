...
export default function FreeAudit({ auth, error }) {
    return (
        <>
            ...
            <div className="min-h-screen bg-gradient-to-b from-indigo-50 via-white to-gray-50 text-gray-800">
                <Header auth={auth} />
                ...
                <main>
                    ...
                    <div className="pt-16 pb-20 px-4 sm:px-6 lg:px-8">
                        <div className="mx-auto max-w-3xl text-center">
                            <p className="text-sm font-semibold text-indigo-600 uppercase tracking-wider">Free — No Credit Card Required</p>
                        ...
                        <div className="mt-12 mx-auto max-w-md space-y-4">
                            <a
                                ...
                                className="flex items-center justify-center w-full px-6 py-4 border-2 border-gray-200 rounded-xl shadow-sm bg-white text-gray-700 font-semibold hover:border-indigo-300 hover:shadow-md transition-all group"
                            >
                                ...
                                Audit My Google Ads
                                <svg className="w-5 h-5 ml-auto text-gray-400 group-hover:text-indigo-500 transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" /></svg>
                            </a>
