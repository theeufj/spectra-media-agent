                ...
                <main>
                    ...
                    <div className="pt-16 pb-20 px-4 sm:px-6 lg:px-8">
                        ...
                        <div className="mt-12 mx-auto max-w-md space-y-4">
                            <div
                                className="flex items-center justify-center w-full px-6 py-4 border-2 border-gray-200 rounded-xl shadow-sm bg-gray-50 text-gray-400 font-semibold cursor-not-allowed"
                            >
                                <svg className="w-6 h-6 mr-3 opacity-50" viewBox="0 0 24 24">
