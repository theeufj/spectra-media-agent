    ...
    return (
        <GuestLayout>
            ...
            <div className="text-center mb-6">
                <div className="mx-auto flex items-center justify-center h-16 w-16 rounded-full bg-flame-orange-100 mb-4">
                    <svg className="h-8 w-8 text-flame-orange-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
