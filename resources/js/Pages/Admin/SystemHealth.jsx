                    ...
                    <div className="max-w-6xl mx-auto">
                        ...
                        <div className="flex justify-between items-center mb-6">
                            ...
                            <button
                                ...
                                disabled={refreshing}
                                className="inline-flex items-center px-4 py-2 bg-brand-dark text-white rounded-lg hover:bg-brand-darker disabled:opacity-50"
                            >
                                ...
                                {healthData.storage.usedPercent !== undefined && (
                                    <>
                                        <div className="w-full bg-gray-200 rounded-full h-2.5 mb-2">
                                            <div 
                                                className={`h-2.5 rounded-full ${healthData.storage.usedPercent > 90 ? 'bg-red-600' : 'bg-brand-dark'}`}
                                                ...
                                                <div className="flex justify-between items-start">
                                                    ...
                                                    <div className="flex space-x-2">
                                                        <button
                                                            ...
                                                            className="text-xs text-brand-dark hover:text-brand-darker"
                                                        >
                                                            Retry
                                                        </button>
                                                        <button
