    ...
    <tr className="hover:bg-gray-50">
        ...
        <td className="px-6 py-4 whitespace-nowrap">
            <span className={`text-sm font-medium ${transaction.status === 'succeeded' ? 'text-green-600' : 'text-gray-600'}`}>
                {/*
                    Rendered "$400.00 AUD" — a dollar sign beside a code that
                    contradicts it. Each row carries its own currency because an
                    admin reads across every tenant, so it is formatted per row
