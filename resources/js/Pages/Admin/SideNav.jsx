    ...
    return (
        <div className="w-64 min-h-screen bg-white shadow-lg">
            ...
            <nav className="mt-4 px-4">
                ...
                <div className="space-y-2">
                    <NavLink href={route('admin.dashboard')} active={url.startsWith('/admin/dashboard')}>
                    ...
                    <NavLink href={route('admin.conversions.index')} active={url.startsWith('/admin/conversions')}>
                    ...
                    <NavLink href={route('admin.ai-costs.index')} active={url.startsWith('/admin/ai-costs')}>
                    ...
                    <NavLink href={route('admin.automation-health')} active={url.startsWith('/admin/automation-health')}>
                ...
                <div className="space-y-2">
                    ...
                    <NavLink href={route('admin.plans.index')} active={url.startsWith('/admin/plans')}>
                        <svg className="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01"></path></svg>
                        <span>Plans</span>
                    </NavLink>
                    <NavLink href={route('admin.mcc-accounts.index')} active={url.startsWith('/admin/mcc-accounts')}>
                        <svg className="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"></path></svg>
                        <span>MCC Accounts</span>
                    </NavLink>
                    <NavLink href={route('admin.feature-flags.index')} active={url.startsWith('/admin/feature-flags')}>
                        <svg className="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 21v-4m0 0V5a2 2 0 012-2h6.5l1 1H21l-3 6 3 6h-8.5l-1-1H5a2 2 0 00-2 2zm9-13.5V9"></path></svg>
                        <span>Feature Flags</span>
                    </NavLink>
                    <NavLink href={route('admin.runtime-exceptions.index')} active={url.startsWith('/admin/runtime-exceptions')}>
                        <svg className="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-2.5L13.732 4c-.77-.833-1.964-.833-2.732 0L4.082 16.5c-.77.833.192 2.5 1.732 2.5z"></path></svg>
                ...
                <div className="space-y-2">
                    <NavLink href={route('admin.notifications.index')} active={url === '/admin/notifications'}>
                    ...
                    <NavLink href={route('admin.email-sequences.index')} active={url.startsWith('/admin/email-sequences')}>
                    ...
                    <NavLink href={route('admin.notification-templates.index')} active={url.startsWith('/admin/notification-templates')}>
                ...
                <div className="space-y-2">
                    <NavLink href={route('admin.help')} active={url.startsWith('/admin/help')}>
