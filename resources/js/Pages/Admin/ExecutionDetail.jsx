            ...
            {plan.steps.map((step, index) => (
                <div key={index} className="flex">
                    <div className="flex flex-col items-center mr-4">
                        <div className="flex items-center justify-center w-8 h-8 rounded-full bg-brand-dark text-white text-sm font-bold">
                            {index + 1}
                        </div>
                    ...
                    <div className="flex-1 bg-gray-50 rounded-lg p-4 mb-2">
                        ...
                        {step.parameters && Object.keys(step.parameters).length > 0 && (
                            <details className="mt-2">
                                <summary className="text-xs text-brand-dark cursor-pointer hover:text-brand-darker">
                                    View parameters
                                </summary>
            ...
            header={
                <div className="flex items-center justify-between">
                    ...
                    <Link
                        ...
                        className="inline-flex items-center px-4 py-2 bg-gray-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700 focus:bg-gray-700 active:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-brand-primary focus:ring-offset-2 transition ease-in-out duration-150"
                    >
