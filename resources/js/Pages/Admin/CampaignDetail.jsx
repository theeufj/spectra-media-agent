                            ...
                            <div className="p-6">
                                    ...
                                    <form onSubmit={handleUpdate} className="mt-6 space-y-4">
                                        ...
                                        <div className="flex gap-2">
                                            <button
                                                type="submit"
                                                disabled={processing}
                                                className="px-4 py-2 bg-brand-dark text-white rounded-lg hover:bg-brand-darker disabled:opacity-50"
                                            >
                                ...
                                {!isEditing && (
                                    <button
                                        ...
                                        className="mt-4 text-sm text-brand-dark hover:text-brand-darker"
                                    >
