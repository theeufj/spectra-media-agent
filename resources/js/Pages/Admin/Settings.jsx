                    ...
                    <div className="max-w-4xl mx-auto">
                        <div className="bg-white shadow-md rounded-lg overflow-hidden">
                            ...
                            <form onSubmit={handleSubmit} className="p-6 space-y-6">
                                ...
                                <div className="border-b border-gray-200 pb-6">
                                    <h4 className="text-lg font-medium text-gray-900 mb-2">Creative Generation Prompt</h4>
                                    ...
                                    <div className="mb-3 p-3 bg-gray-50 rounded-lg text-sm text-gray-600 flex flex-wrap gap-x-6 gap-y-1">
                                        ...
                                        {lastImageGeneration ? (
                                            <span>
                                                Last generation: <strong className="font-mono">{lastImageGeneration.model}</strong>
                                                {' '}on {new Date(lastImageGeneration.created_at).toLocaleString()}
                                            </span>
                                        ) : (
                                            <span>No image generations recorded yet.</span>
                                        )}
                                    </div>
                                    ...
                                    <textarea
                                        ...
                                        placeholder={imagePromptDefault}
                                    ...
                                    <div className="mt-2 flex items-start justify-between gap-4 flex-wrap">
                                        <p className="text-xs text-gray-500">
                                            ...
                                            <code className="bg-gray-100 px-1 rounded">{'{{brand_context}}'}</code> (colours + visual style),{' '}
                                            <code className="bg-gray-100 px-1 rounded">{'{{product_context}}'}</code> (product details),{' '}
                                            <code className="bg-gray-100 px-1 rounded">{'{{creative_strategy}}'}</code> (the strategy's imagery brief — required).
                                        </p>
                                        <div className="flex gap-3 text-xs">
                                            {!data.image_prompt_template && (
                                                <button
                                                    type="button"
                                            ...
                                            {data.image_prompt_template && (
                                                <button
                                                    type="button"
                                                    onClick={() => setData('image_prompt_template', '')}
