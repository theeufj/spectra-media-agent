...
export default function Pricing({ auth, plans = [] }) {
    ...
    const faqs = [
        ...
        { question: "What happens if my ad gets disapproved?", answer: "Our Self-Optimising Agent automatically detects disapproved ads and rewrites the copy to be policy-compliant while maintaining your brand voice. It then resubmits the ad—all without any action needed from you. Underperforming ads are also automatically paused to protect your budget." },
