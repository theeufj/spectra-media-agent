...
export default function Pricing({ auth }) {
    ...
    const faqs = [
        ...
        { question: "Does the subscription price include my ad budget?", answer: "No. Your subscription covers the Spectra AI platform, the creative generation, and the autonomous management agents. You will connect your own credit card to Google/Facebook, so you pay the ad networks directly for your media spend. This ensures total transparency—we never mark up your ad costs." },
