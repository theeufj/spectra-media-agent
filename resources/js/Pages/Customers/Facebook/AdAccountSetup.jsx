                                ...
                                <div>
                                    ...
                                    <div className="flex rounded-md shadow-sm">
                                        ...
                                        <input
                                            ...
                                            className="flex-1 min-w-0 block px-3 py-2 rounded-none rounded-r-md border border-gray-300 focus:ring-brand-primary focus:border-brand-primary text-sm font-mono"
                                            required
                                        />
                                    </div>
