        ...
        <div className="space-y-8">
            ...
            <div className="flex items-center justify-between">
                ...
                <a
                    ...
                    className="inline-flex items-center px-5 py-2.5 bg-brand-dark text-white rounded-lg hover:bg-brand-darker transition font-medium shadow-md"
                >
                                ...
                                <div className="space-y-3">
                                    {strategy.sample_ad_concepts.map((ad, adIdx) => (
                                        <div key={adIdx} className="bg-gray-50 border border-gray-200 rounded-lg p-4">
                                            ...
                                            {ad.call_to_action && (
                                                <div className="text-brand-dark text-xs font-semibold mt-2">{ad.call_to_action}</div>
                                            )}
                                        </div>
                                    ))}
                                </div>
