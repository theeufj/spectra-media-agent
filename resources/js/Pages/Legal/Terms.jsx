                ...
                <div className="flex-1 font-sans text-gray-900 antialiased">
                    <div className="pt-4 bg-gray-100">
                        <div className="min-h-screen flex flex-col items-center pt-6 sm:pt-0">
                            ...
                            <h2 className="text-2xl lg:text-3xl font-bold text-gray-800 pt-6 border-t mt-8">1. Accounts</h2>
                            <div className="mt-8 space-y-6 text-gray-700 leading-relaxed">
                                ...
                                <p>You may revoke our access to any advertising platform account at any time, but doing so will prevent us from managing campaigns on that platform and may result in termination of your subscription without refund.</p>
                                ...
                                <p><strong className="font-semibold text-gray-800">One-Time Setup and Early Exit:</strong> Campaign setup — including account structure, campaigns, ad copy, creative, and conversion tracking configuration — is a paid service, offered either as a standalone one-time setup (at our published setup fee, currently US$999) or included with an ongoing subscription. Where we build campaigns inside an advertising account that you own or control, the included setup is earned over your first three (3) months of paid subscription. If, within that period, you cancel your subscription or revoke our manager access to that account, the one-time setup fee becomes payable, less subscription fees you have already paid. We will notify you of any amount assessed under this clause before collecting it. This clause does not apply to accounts we provision and operate on your behalf, or to engagements purchased as a one-time setup.</p>
                                ...
                                <ul className="list-disc list-inside pl-4 space-y-2">
                                    ...
                                    <li>You are ultimately responsible for ensuring your advertising complies with all applicable platform policies and laws</li>
                                    <li>We are not liable for any account suspensions, ad disapprovals, or policy violations from any advertising platform</li>
                                ...
                                <ul className="list-disc list-inside pl-4 space-y-2">
                                    ...
                                    <li>We will cease all management of your advertising campaigns across all platforms</li>
                                    <li>Your advertising platform accounts will remain active and under your control</li>
                                    <li>You will remain responsible for any outstanding fees</li>
                                    <li>We will revoke our access to your advertising platform accounts within 48 hours</li>
                                </ul>
                                ...
                                <ul className="list-disc list-inside pl-4 space-y-2">
                                    ...
                                    <li>Your violation of any third-party rights, including Google's terms</li>
