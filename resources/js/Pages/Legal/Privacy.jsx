                    ...
                    <div className="pt-4 bg-gray-100">
                        <div className="min-h-screen flex flex-col items-center pt-6 sm:pt-0">
                            <div className="w-full sm:max-w-4xl mt-6 p-8 bg-white shadow-md overflow-hidden sm:rounded-lg">
                                ...
                                <p>sitetospend uses the collected data for various purposes:</p>
                                <ul className="list-disc list-inside pl-4 space-y-2">
                                ...
                                <ul className="list-disc list-inside pl-4 space-y-2">
                                    ...
                                    <li><strong className="font-semibold">Google Ads Management:</strong> We manage Google Ads campaigns on your behalf through our platform's managed account infrastructure. Individual users do not need to grant direct Google Ads API access — campaigns are managed through sub-accounts created under our agency account.</li>
                                ...
                                <ul className="list-disc list-inside pl-4 space-y-2">
                                    ...
                                    <li><strong>Data Export:</strong> Before deletion, you may request an export of your data by contacting support@sitetospend.com.</li>
                                    <li><strong>Complete Deletion Request:</strong> To request immediate and complete deletion of all your data, contact us at support@sitetospend.com. We will process your request within 30 days.</li>
                                </ul>
