                ...
                <div className="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
                            ...
                            <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left flex-1">
                                ...
                                <div className="mt-4">
                                    ...
                                    <p className="text-sm text-gray-600 mb-3">
                                        We're preparing the creative selected for this campaign:
                                    </p>
                                    <ul className="text-sm text-gray-600 space-y-2 mb-4">
                                        <li className="flex items-start">
                                            ...
                                            <span>Writing your ad copy</span>
                                        </li>
                                        <li className="flex items-start">
                                            <svg className="h-5 w-5 text-green-500 mr-2 flex-shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                                            </svg>
                                            <span>Rendering the selected visual concepts</span>
                                        </li>
                                        <li className="flex items-start">
                                            <svg className="h-5 w-5 text-green-500 mr-2 flex-shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                                            </svg>
                                            <span>Preparing the formats your campaign uses</span>
                                        </li>
                                    </ul>
                                    <div className="rounded-lg border p-4" style={{ backgroundColor: brandTint(10), borderColor: brandTint(30) }}>
                                        <div className="flex">
                                            ...
                                            <p className="text-sm text-brand-darker">
                                                <strong>You'll receive an email</strong> when generation finishes. Review the results and any items needing attention before using your ads.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div className="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                        <button
                            type="button"
                            onClick={onClose}
                            className="w-full inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-gradient-to-r from-purple-600 to-brand-dark text-base font-medium text-white hover:from-purple-700 hover:to-brand-darker focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500 sm:ml-3 sm:w-auto sm:text-sm transition-all"
                        >
                            Got it!
                        </button>
                    </div>
