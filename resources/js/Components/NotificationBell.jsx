                        ...
                        <div className="flex items-center space-x-3">
                            {unreadCount > 0 && (
                                <button
                                    ...
                                    className="text-xs text-brand-primary/20 hover:text-white font-medium transition-colors"
                                >
                                    Mark all read
                                </button>
                            )}
                            <button
                                ...
                                className="text-brand-primary/20 hover:text-white transition-colors"
                                title="Refresh"
                            >
