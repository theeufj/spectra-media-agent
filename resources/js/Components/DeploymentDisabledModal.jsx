                    ...
                    <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                        <div className="sm:flex sm:items-start">
                            <div
                                ...
                                style={{ backgroundImage: `linear-gradient(to bottom right, #dbeafe, ${brandTint(20)})` }}
                            >
                            ...
                            <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left flex-1">
                                ...
                                <div className="mt-4">
                                    ...
                                    <div
                                        className="rounded-lg p-4 border border-blue-200 mb-4"
                                        style={{ backgroundImage: `linear-gradient(to right, #eff6ff, ${brandTint(10)})` }}
                                    >
