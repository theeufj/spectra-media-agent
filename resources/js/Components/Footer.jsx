            ...
            <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
                    ...
                    <div>
                        ...
                        <ul className="mt-4 space-y-3">
                            ...
                            <li><Link href="/free-audit" className="text-sm text-gray-400 hover:text-white transition-colors">Free Ad Audit</Link></li>
                        </ul>
                    </div>
                ...
                <div className="mt-12 pt-8 border-t border-gray-800 flex flex-col sm:flex-row justify-between items-center">
                    ...
                    <div className="mt-4 sm:mt-0 flex items-center space-x-6">
                        <a href="https://proveably.com/portal/public/trust/b294b3b8-245a-469c-a8fc-e478db31c249" target="_blank" rel="noopener noreferrer" className="flex items-center space-x-1.5 text-sm text-gray-500 hover:text-gray-300 transition-colors">
                            <img src="https://proveably.com/portal/public/trust/b294b3b8-245a-469c-a8fc-e478db31c249/badge.svg" alt="Secured by Proveably" className="h-5 w-5" />
                            <span>Secured by Proveably</span>
                        </a>
