...
3.  **Generate Prompts — always exactly 3, and they must genuinely differ.**
    ...
    *   If the strategy contains an "Also suits:" sentence, those are alternative subjects the business has already approved. Use them. They exist precisely so you do not have to invent the range yourself.
