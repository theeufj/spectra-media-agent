...
class ExtendVideo implements ShouldQueue
{
    ...
    public function handle(GeminiService $geminiService): void
    {
        ...
        try {
            ...
            //
            // The stored gemini_video_uri is the URI Veo returned at generation time
            // (format: files/xxx:download?alt=media). Strip the download suffix so the
            // extension API receives the base resource URI (files/xxx) it expects.
