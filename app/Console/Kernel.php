...
use App\Jobs\WeeklyBudgetRebalance;
...
class Kernel extends ConsoleKernel
{
    ...
    protected function schedule(Schedule $schedule): void
    {
        ...
        $schedule->job(new SendDailyPerformanceReports)->dailyAt('08:00');

        // Weekly jobs
        $schedule->job(new WeeklyBudgetRebalance)->weeklyOn(1, '06:00'); // Monday 06:00
