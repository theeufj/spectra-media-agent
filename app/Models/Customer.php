...
{
    use HasEncryptedAttributes, HasFactory, HasPublicUuid, SoftDeletes;
    ...
    protected $fillable = [
        ...
        'war_room_competitors',
        'war_room_gap_analysis',
        'war_room_gap_analysis_at',
        'country',
        'timezone',
        'currency_code',
        'website',
    ...
    protected $casts = [
        ...
        'war_room_competitors' => 'array',
        'war_room_gap_analysis' => 'array',
        'war_room_gap_analysis_at' => 'datetime',
